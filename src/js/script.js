...
function PageIsInFrame() {
    if (MobileAndTablet()) {
        ...
        for (let i = 0; i < sectionBlocks.length; ) {
            ...
            sectionBlocks[i].querySelector("#st").classList.remove("section-text");

            sectionBlocks[i].querySelector("#sT").classList.add("section-title-framed");
            sectionBlocks[i].querySelector("#sT").classList.remove("section-title");

            sectionBlocks[i].classList.remove("section-block");
        }
    }
}
